        ...
        <div className="relative flex min-h-[16rem] min-w-0 items-center justify-center md:min-h-[14.75rem] lg:min-h-[17rem] xl:min-h-[18rem]">
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
            ...
            <img
              ...
              alt=""
              aria-hidden="true"
              className="w-[82%] max-w-[640px] -translate-y-1 object-contain opacity-14 blur-[0.8px] saturate-125 sm:w-[76%] sm:max-w-[760px] md:max-w-[720px] md:-translate-y-6 lg:w-[70%] lg:max-w-[900px] lg:-translate-y-7 xl:w-[62%] xl:max-w-[920px] xl:-translate-y-8 2xl:w-[58%] 2xl:max-w-[900px] 2xl:-translate-y-9"
            />
          </div>
