        ...
        <div className="relative overflow-hidden rounded-[38px] border border-white/10 bg-white/[0.045] px-7 py-10 shadow-[0_45px_120px_-60px_rgba(34,211,238,0.6)] sm:px-10 sm:py-12">
          ...
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
            <img
              ...
              alt=""
              aria-hidden="true"
              className="w-[78%] max-w-[740px] translate-y-4 object-contain opacity-22 blur-[0.8px] saturate-125 sm:w-[82%] sm:max-w-[860px] sm:translate-y-2 lg:w-[72%] lg:max-w-[980px] lg:translate-y-4 xl:w-[64%] xl:max-w-[920px] xl:translate-y-1 2xl:w-[60%] 2xl:max-w-[900px] 2xl:-translate-y-1"
            />
          </div>
