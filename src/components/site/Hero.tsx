...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-10 sm:pt-12 md:pt-9 xl:pt-8">
      <div className="mx-auto max-w-7xl px-6 pb-6 md:pb-5 xl:pb-4">
        <div className="relative flex min-h-[16rem] items-center justify-center md:min-h-[14.75rem] lg:min-h-[17rem] xl:min-h-[18rem]">
          ...
          <div className="relative flex w-full max-w-5xl flex-col items-center justify-center text-center">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center md:mt-5 lg:mt-7">
              <a href="#library">
