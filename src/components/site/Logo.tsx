...
export function Logo() {
  return (
    <Link
      href="/"
      className="group inline-flex items-center gap-2 text-zinc-100 transition-colors lg:gap-2.5"
    >
      ...
      <span className="flex flex-col leading-tight">
        <span className="whitespace-nowrap text-xs font-semibold tracking-tight md:text-sm">
          เอาน้อยนอนบ้าน <span className="font-normal text-zinc-400">Gang</span>
        </span>
        <span className="text-[9px] uppercase tracking-[0.16em] text-zinc-500 sm:text-[10px] sm:tracking-[0.18em]">
          Private Cloud Space
        </span>
      </span>
    </Link>
